...
return false});c(d).on("click","div.ui.dimmer.modals",function(a){c(a.target).hasClass("modal")&&b._shown&&b._dte.background()})}return b},open:function(a,d,e){if(b._shown)e&&e();else{b._dte=a;b._shown=true;var a=b._dom.modal,f=c(d).children();a.children().detach();a.append(f).prepend(a.children(".header")).addClass(d.className).prepend(b._dom.close);c(b._dom.modal).modal("setting",{dimmerSettings:{closable:false},onVisible:function(){b._dte.s.setFocus&&b._dte.s.setFocus.focus();e&&e()},onHidden:function(){c(d).append(f);
b._shown=false}}).modal("show")}},close:function(a,c){var d=b._dom.modal;if(b._shown){d.modal("hide");b._dte=a;b._shown=false}c&&c()},node:function(){return b._dom.modal[0]},_shown:!1,_dte:null,_dom:{}});b=a.Editor.display.semanticui;return a.Editor});
