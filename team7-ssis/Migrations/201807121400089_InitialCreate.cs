    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                {
                    DeliveryOrderNo = c.String(nullable: false, maxLength: 20),
                    PurchaseOrderNo = c.String(maxLength: 20),
            ...
            CreateTable(
                ...
                {
                    DisbursementId = c.String(nullable: false, maxLength: 20),
                    RetrievalId = c.String(maxLength: 20),
                    Remarks = c.String(maxLength: 200),
                    StatusId = c.Int(),
                ...
                .ForeignKey("dbo.Retrievals", t => t.RetrievalId)
                .ForeignKey("dbo.Status", t => t.StatusId)
                .ForeignKey("dbo.AspNetUsers", t => t.CollectedBy_Id)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedBy)
                .ForeignKey("dbo.AspNetUsers", t => t.UpdatedBy)
                .Index(t => t.RetrievalId)
                .Index(t => t.StatusId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Retrievals", "UpdatedBy", "dbo.AspNetUsers");
            DropForeignKey("dbo.Retrievals", "CreatedBy", "dbo.AspNetUsers");
            ...
            DropForeignKey("dbo.DisbursementDetails", "UpdatedBy", "dbo.AspNetUsers");
            ...
            DropForeignKey("dbo.DeliveryOrderDetails", "UpdatedBy", "dbo.AspNetUsers");
            DropForeignKey("dbo.StockMovements", new[] { "DeliveryOrderNo", "DeliveryOrderDetailItemCode" }, "dbo.DeliveryOrderDetails");
            DropForeignKey("dbo.DeliveryOrderDetails", "StatusId", "dbo.Status");
            ...
            DropForeignKey("dbo.DisbursementDetails", "StatusId", "dbo.Status");
            DropForeignKey("dbo.DisbursementDetails", "ItemCode", "dbo.Items");
            DropForeignKey("dbo.Disbursements", "StatusId", "dbo.Status");
            DropForeignKey("dbo.Retrievals", "StatusId", "dbo.Status");
            DropForeignKey("dbo.Requisitions", "RetrievalId", "dbo.Retrievals");
            ...
            DropForeignKey("dbo.Disbursements", "RetrievalId", "dbo.Retrievals");
            ...
            DropIndex("dbo.Requisitions", new[] { "RetrievalId" });
            ...
            DropIndex("dbo.Retrievals", new[] { "UpdatedBy" });
            DropIndex("dbo.Retrievals", new[] { "CreatedBy" });
            DropIndex("dbo.Retrievals", new[] { "StatusId" });
            ...
            DropIndex("dbo.Disbursements", new[] { "RetrievalId" });
            DropIndex("dbo.DisbursementDetails", new[] { "UpdatedBy" });
            DropIndex("dbo.DisbursementDetails", new[] { "StatusId" });
            ...
            DropIndex("dbo.DeliveryOrderDetails", new[] { "UpdatedBy" });
            DropIndex("dbo.DeliveryOrderDetails", new[] { "StatusId" });
